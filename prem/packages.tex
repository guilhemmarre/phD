...
\usepackage{float}
\usepackage{parskip} % paragraph positioning management
...
pdffitwindow=true,
colorlinks=true,
linkcolor=black, % couleur des liens internes au texte
...
\definecolor{resume}{RGB}{238, 206, 196}
...
\newcommand\monimage{\includegraphics[width =17pt]{loupe.png}}
...
\setlength{\parskip}{0.4cm plus1mm}
\setlength{\parindent}{0.5cm} % indentation pour un nouveau paragraphe
\setlength{\itemsep}{3pt}
\raggedbottom % controle la manière dont est répartie le text dans une page
...
\begin{picture}(0,0)(5,5) % (width,height)(x-offset,y-offset)
    ...
    \begin{picture}(0,0)(35,-3)
        \textcolor{white}{\fontsize{14}{14}{Introduction}}
    \end{picture} 
\end{picture}   
}
...
\begin{picture}(0,0)(35,5) % (width,height)(x-offset,y-offset)
...
\fancypagestyle{intro}{
    ...
    \fancyfoot[CE]{\vspace*{0.05cm}\includegraphics[width=12cm]{images/misc/bandeau_bas.png}\\} % Pied de page avec le récif
...
\fancypagestyle{main}{
	...
	\renewcommand{\headrulewidth}{0pt}
	%\fancyhead[RO]{\rblob{\chaptername~\thechapter}} % Affichage du chapitre en haut à droite sur les pages impaires
	%\fancyhead[LE]{\lblob{\chaptername~\thechapter}} % Affichage du chapitre en haut à gauche sur les pages paires
	\fancyhead[RO]{\rblueband}
	\fancyhead[LE]{\lblueband}
	\fancyhead[RE]{\rsection}
	\fancyhead[LO]{\lsection}
	%\fancyhead[LO]{\section} % Affichage du chapitre en haut à droite sur les pages impaires
	%\fancyhead[RE]{\thesection} % Affichage du chapitre en haut à gauche sur les pages paires
...
\fancypagestyle{appendix}{
	...
	\renewcommand{\headrulewidth}{0pt}
	%\fancyhead[RO]{\rblob{\appendixname~\thechapter}}
	%\fancyhead[LE]{\lblob{\appendixname~\thechapter}}
	\fancyfoot[LE]{\numberbaleine}
	\fancyfoot[RO]{\numberbaleine}
}
...
\fancypagestyle{plain}{
    ...
    \setlength{\headsep}{42pt}
    \renewcommand{\headrulewidth}{0pt}
    %\fancyhead[RO]{\rblobblue{\hphantom{\chaptername~\thechapter}}}
    %\fancyhead[LE]{\lblob{\hphantom{\chaptername~\thechapter}}}
    \fancyfoot[LE]{\numberbaleine}
    \fancyfoot[RO]{\numberbaleine}
}
...
\renewcommand{\bibname}{RÉFÉRENCES BIBLIOGRAPHIQUES} % Titre de la table bibliographique
