...
\begin{appendices}
    ...
    %\chapter{Autres modélisations 3D par photogrammétrie} \label{annexe-modelisations}
    %\includepdf[scale=1, pages=-,pagecommand={\thispagestyle{appendix}}]{./annexes/Modelisations.pdf}
    
    %\chapter{Missions de terrain avec Andromède Océanologie} \label{annexe-terrain}
